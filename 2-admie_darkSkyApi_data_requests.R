...
list.of.api.keys = c("837efbc72aaaec75644a22c1488ecbcf",
                     "680e0da95389cfe69760a38af253617c",
                     "b8c4c289e035b3024a466e8d886b3fa9",
...
days <- seq(from=as.Date('2010-10-01'), to=as.Date("2017-05-30"),by='days' )
...
darkSky.WeatherData = 
  darkSky.WeatherData[-grep("pressure",names(darkSky.WeatherData))]

darkSky.WeatherData = 
  darkSky.WeatherData[-grep("precipType",names(darkSky.WeatherData))]
