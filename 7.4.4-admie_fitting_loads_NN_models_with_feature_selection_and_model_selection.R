...
for(i in 1:24) {
  ...
  for(hiddenLayerNeurons in seq(2, 14, 1)) {
    for(maxitValue in seq(10, 160, 10)) {
      
      cat("\n\n tuning model: Load.",i-1,"with feature selection and hiddenLayerNeurons = ", hiddenLayerNeurons," maxitValue = ", maxitValue," \n")
