...
prediction.ensembling.fs.ms = c(
  rbind(
    ...
    get(str_pred_ensembling[5])[[5]], #here it is a neural network, thus the special handling
    get(str_pred_ensembling[6])[[6]][1:365, 1],
    get(str_pred_ensembling[7])[[7]],
    get(str_pred_ensembling[8])[[8]],
    get(str_pred_ensembling[9])[[9]],
    get(str_pred_ensembling[10])[[10]][1:365, 1],
