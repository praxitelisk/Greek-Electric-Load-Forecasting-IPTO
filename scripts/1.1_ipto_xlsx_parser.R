...
test$SETTLED.ENERGY.SUPPLIED.TO.CUSTOMERS.FOR.ALL.LOAD.REPRESENTATIVES..MWh.[test$SETTLED.ENERGY.SUPPLIED.TO.CUSTOMERS.FOR.ALL.LOAD.REPRESENTATIVES..MWh. < 2000] = test$SETTLED.ENERGY.SUPPLIED.TO.CUSTOMERS.FOR.ALL.LOAD.REPRESENTATIVES..MWh.[test$SETTLED.ENERGY.SUPPLIED.TO.CUSTOMERS.FOR.ALL.LOAD.REPRESENTATIVES..MWh. < 2000] * 10
